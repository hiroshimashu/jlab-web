...
const Partner = () => {
    return (
        <Fade bottom>
            ...
            <div className="partner-wrapper-small">
                <div>
                    <div className="partner-img1-small-wrapper">
                        <img src =  {cwip} alt = "partner-img1-small" className="partner-img1-small"/>
                    </div>
                    <p className="partner-img1-small-text">
                        ※株式会社JLabsは、CWIP認定パートナーです。WidevineDRMを使用したクライアントにも対応しています 。
                    </p>
                </div>
                <div>
                    <div className="partner-img2-small-wrapper">
                        <img src =  {zwave} alt = "partner-img2" className="partner-img2-small"/>
                    </div>
                    <p className="partner-img2-small-text">
                        ※株式会社JLabsは、Z-waveアライアンスメンバーです。
                    </p>
                </div>
            </div>
